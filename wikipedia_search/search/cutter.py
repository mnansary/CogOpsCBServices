...
Document:
1. পাসপোর্ট করার নিয়ম:
2. প্রয়োজনীয় কাগজপত্র:
3. ১. জাতীয় পরিচয়পত্র
4. ২. নাগরিকত্ব সনদ
5. ফি জমা দেওয়ার নিয়ম:
Output: [(2, 4)]
...
class ContextCutterAgent:
    ...
    async def get_cut_ranges(self, query: str, numbered_passage: str) -> list[tuple[int, int]]:
        """
        ...
        try:
            resp = await self.client.chat.completions.create(
                ...
                messages=[
                    ...
                    {"role": "user", "content": USER_PROMPT.format(query=query, numbered_passage=numbered_passage)},
                ],
                temperature=0.0,
